...
public class OutputOperation extends AbstractInteractionOperation{
	
	private static final String CORRELATION_SET_OUTPUT_OPERATION_INTERACTION = "OutputOperationInteraction-";
	private static final String CORRELATION_SET_OUTPUT_OPERATION_PROCESS = "OutputOperationProcess-";
	private static final String VARIABLE_DATA_OUTPUT_RESPONSE = "dataOutputResponse";
	private static final String VARIABLE_DATA_OUTPUT_REQUEST = "dataOutputRequest";
	static protected int operationCounter = 1;

	public OutputOperation(Operation inputOperation, Operation genOperation, Variable genVar,
	...
	protected void createDataOutputVar() {
		...
		inputVariable.setName(VARIABLE_DATA_OUTPUT_REQUEST + operationCounter);
		inputVariable.setMessageType((Message) operation.getInput()
				.getMessage());
		outputVariable = BPELFactory.eINSTANCE.createVariable();
		outputVariable.setName(VARIABLE_DATA_OUTPUT_RESPONSE + operationCounter);
	...
	protected void createCorrelationSets(Property propertyProcessId, Property propertyInteractionId) {
		...
		processCS.setName(CORRELATION_SET_OUTPUT_OPERATION_PROCESS+operationCounter);
		...
		interactionCS.setName(CORRELATION_SET_OUTPUT_OPERATION_INTERACTION+operationCounter);
