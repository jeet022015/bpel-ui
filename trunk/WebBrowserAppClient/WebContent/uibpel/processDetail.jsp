...
<%
	...
	System.out.println("detail for process = "+ process);
%>
</head>
											...
											<tr>
												<td ALIGN="left"  VALIGN="top">
													...
													%>
														...
														<li>&nbsp;<font size="3" face="Arial">User interaction <%=ui.getId()%></a>: done. <a href="/WebBrowserAppClient/uibpel/detailUserInter.jsp?processId=<%=process.getId()%>&cuiId=<%=ui.getId()%>">Details</a></font></li> 
													...
													%>
														...
														<li>&nbsp;<font size="3" face="Arial">User interaction <%=ui.getId()%>: <a href="/WebBrowserAppClient/UiControler?processId=<%=process.getId()%>&cuiId=<%=ui.getId()%>">pending</a></font></li> 
