...
/**
 * This class was generated by Apache CXF 2.5.0 2011-11-18T15:25:02.268+01:00
...
@javax.jws.WebService(serviceName = "UI-Client",
					  portName = "UI-ClientSOAP",
					  targetNamespace = "http://webApp.fundp.ac.be",
					  wsdlLocation = "http://localhost:8070/WebBrowserAppClient/wsdl/UI-Client.wsdl",
					  endpointInterface = "be.ac.fundp.webapp.service.provider.UIClient")
public class UIClientImpl implements UIClient {

	/** The Constant LOG. */
	private static final Logger LOG = Logger.getLogger(UIClientImpl.class
			.getName());
	 ...
	 * 
	 * @see
	 * be.ac.fundp.webapp.service.provider.UIClient#requireAssyncInteraction
	 * (java.lang.String, java.util.List, java.lang.String, java.lang.String)
	 */
	public void requireAssyncInteraction(String cuiId,
			List<DataItemType> inputData, String role, String processId) {
		LOG.info("Executing operation requireAssyncInteraction");
		System.out.println(cuiId);
		System.out.println(inputData);
		System.out.println(role);
		System.out.println(processId);
		Process p = uiManager.retrieveProcess(role, processId);
		UserInteraction ui = p.createUserInteraction(cuiId);
		for (DataItemType dataItemType : inputData) {
			ui.addPresentedDataItem(dataItemType.getDataItemId(),
	 ...
	 * 
	 * @see
	 * be.ac.fundp.webapp.service.provider.UIClient#requireSyncInteraction(java
	 * .lang.String, java.util.List, java.lang.String, java.lang.String)
	 */
	public List<DataItemType> requireSyncInteraction(String cuiId,
			List<DataItemType> inputData, String role, String processId) {
		...
		List<DataItem> dataSentBack = Collections.emptyList();
		try {
			dataSentBack = ui.getProvidedData();
		...
		// uiManager.addUserInteraction(cuiId, role, processId, inputData);
		// try {
		// List<DataItem> dataSentBack = uiManager.waitDataFromUser(cuiId, role,
		// processId);
		// List<DataItemType> response = new ArrayList<DataItemType>();
		// for (DataItem aDataItem : dataSentBack) {
		// DataItemType aReturningDataType = new DataItemType();
