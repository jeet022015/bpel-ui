 ...
 * <ul>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.OnUserEventImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.OnUserEventImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.OnUserEventImpl#getUserRole <em>User Role</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.OnUserEventImpl#getType <em>Type</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.OnUserEventImpl#getID <em>ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
