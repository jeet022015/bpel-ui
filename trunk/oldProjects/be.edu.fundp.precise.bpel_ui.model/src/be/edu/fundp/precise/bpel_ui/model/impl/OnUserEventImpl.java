 ...
 *   <li>{@link be.edu.fundp.precise.bpel_ui.model.impl.OnUserEventImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OnUserEventImpl extends BPEL_UI_EntityImpl implements OnUserEvent {
	...
	public void setId(String newId) {
		...
		if (!isReconciling) {
			ReconciliationHelper.replaceAttribute(this, ModelPackage.eINSTANCE
					.getOnUserEvent_Id().getName(),newId);
		}
		id = newId;
	...
	public void setType(UserEventType newType) {
		...
		if (!isReconciling) {
			ReconciliationHelper.replaceAttribute(this, ModelPackage.eINSTANCE
					.getOnUserEvent_Type().getName(),type.getLiteral());
		}
		if (eNotificationRequired())
