...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.USABLE_ENTITY: {
				UsableEntity usableEntity = (UsableEntity)theEObject;
				T result = caseUsableEntity(usableEntity);
				if (result == null) result = caseBPELExtensibleElement(usableEntity);
				if (result == null) result = caseExtensibleElement(usableEntity);
				if (result == null) result = caseWSDLElement(usableEntity);
				if (result == null) result = caseIElementExtensible(usableEntity);
				if (result == null) result = caseIAttributeExtensible(usableEntity);
			...
			case ModelPackage.USER_INTERACTION: {
				...
				if (result == null) result = caseUsableEntity(userInteraction);
			...
			case ModelPackage.DATA_INPUT_UI: {
				...
				if (result == null) result = caseUsableEntity(dataInputUI);
			...
			case ModelPackage.DATA_OUTPUT_UI: {
				...
				if (result == null) result = caseUsableEntity(dataOutputUI);
			...
			case ModelPackage.DATA_SELECTION_UI: {
				...
				if (result == null) result = caseUsableEntity(dataSelectionUI);
			...
			case ModelPackage.ON_USER_EVENT: {
				...
				if (result == null) result = caseUsableEntity(onUserEvent);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Usable Entity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Usable Entity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUsableEntity(UsableEntity object) {
		return null;
	}
