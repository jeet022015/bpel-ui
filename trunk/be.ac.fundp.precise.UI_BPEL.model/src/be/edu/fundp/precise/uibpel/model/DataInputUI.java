 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.uibpel.model.DataInputUI#getInputVariable <em>Input Variable</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DataInputUI extends UserInteraction {
	 ...
	 * @see be.edu.fundp.precise.uibpel.model.ModelPackage#getDataInputUI_InputVariable()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link be.edu.fundp.precise.uibpel.model.DataInputUI#getInputVariable <em>Input Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
