 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.uibpel.model.impl.DataItemImpl#getDescription <em>Description</em>}</li>
...
public class DataItemImpl extends BPELExtensibleElementImpl implements DataItem {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DATA_ITEM__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.DATA_ITEM__DESCRIPTION:
