	...
	<div id="main">
	  <div id="outer-prettification">
	    <div id="inner-prettification">
	      ...
	      <div id="header">
		<h1 id="title"><a href="index.html">No interactions required.</a></h1>
	      </div>
	      
	      <div id="contents">
			<form action="/BrowserAppClient/UiController" method="get">
				<p>Click on the button in order to check out for new interactions.</p>
				<ol>
			        <li id="send">
			        	<button type="submit">Next Interactions</button>
			        </li>
