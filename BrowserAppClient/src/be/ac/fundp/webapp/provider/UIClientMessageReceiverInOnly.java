...
/**
 * UIClientMessageReceiverInOnly.java
 *
 ...
 */
        ...
        /**
        *  UIClientMessageReceiverInOnly message receiver
        */

        public class UIClientMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractInMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("requireAssyncInteraction".equals(methodName)){
            
            be.ac.fundp.webapp.RequireAssyncInteraction wrappedParam = (be.ac.fundp.webapp.RequireAssyncInteraction)fromOM(
                                                        inMessage.getEnvelope().getBody().getFirstElement(),
                                                        be.ac.fundp.webapp.RequireAssyncInteraction.class,
                                                        getEnvelopeNamespaces(inMessage.getEnvelope()));
                                            
                                                     skel.requireAssyncInteraction(wrappedParam);
