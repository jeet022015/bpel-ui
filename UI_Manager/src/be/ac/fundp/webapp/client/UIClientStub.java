...
public class UIClientStub extends org.apache.axis2.client.Stub {
	...
	public UIClientStub(
		...
		this(configurationContext,
				"http://localhost:8090/ClientApp/services/UI-Client/");
	...
	public UIClientStub() throws org.apache.axis2.AxisFault {
		...
		this("http://localhost:8090/ClientApp/services/UI-Client/");
	...
	public void requireAssyncInteraction(
			be.ac.fundp.webapp.client.UIClientStub.RequireAssyncInteraction requireAssyncInteraction0
	 ...
	 * Auto generated method signature
	 * 
	 * @see be.ac.fundp.webapp.client.UIClient#requireSyncInteraction
	 * @param requireSyncInteraction1
	 */

	public be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse requireSyncInteraction(

			be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteraction requireSyncInteraction1)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse.class,
					getEnvelopeNamespaces(_returnEnv));

			return (be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse) object;
	 ...
	 * 
	 * @see be.ac.fundp.webapp.client.UIClient#startrequireSyncInteraction
	 * @param requireSyncInteraction1
	 */
	public void startrequireSyncInteraction(
			...
			final be.ac.fundp.webapp.client.UIClientCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultrequireSyncInteraction((be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse) object);
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://webApp.fundp.ac.be".equals(namespaceURI)
					&& "UIDataType".equals(typeName)) {

				return UIDataType.Factory.parse(reader);
	...
	public static class UIDataType implements
			org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * UIDataType Namespace URI = http://webApp.fundp.ac.be Namespace Prefix
		 * = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":UIDataType", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "UIDataType", xmlWriter);
				}
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static UIDataType parse(
					javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				UIDataType object = new UIDataType();
				...
				try {
					...
					if (reader
						...
						if (fullTypeName != null) {
							...
							if (!"UIDataType".equals(type)) {
								// find namespace for the prefix
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (UIDataType) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class RequireAssyncInteraction implements
		...
		protected UIDataType[] localInputData;
		 ...
		 * @return UIDataType[]
		 */
		public UIDataType[] getInputData() {
		 ...
		 */
		protected void validateInputData(UIDataType[] param) {
		 ...
		 *            InputData
		 */
		public void setInputData(UIDataType[] param) {
		 ...
		 *            UIDataType
		 */
		public void addInputData(UIDataType param) {
			if (localInputData == null) {
				localInputData = new UIDataType[] {};
			}
			...
			list.add(param);
			this.localInputData = (UIDataType[]) list
					.toArray(new UIDataType[list.size()]);
			...
			public static RequireAssyncInteraction parse(
				...
				try {
					...
					if (reader.isStartElement()
						...
						// end.
						list2.add(UIDataType.Factory.parse(reader));
						...
						object.setInputData((UIDataType[]) org.apache.axis2.databinding.utils.ConverterUtil
								.convertToArray(UIDataType.class, list2));
	...
	public static class RequireSyncInteractionResponse implements
		...
		protected UIDataType[] localOutData;
		 ...
		 */
		protected void validateOutData(UIDataType[] param) {
		 ...
		 *            OutData
		 */
		public void setOutData(UIDataType[] param) {
		 ...
		 *            UIDataType
		 */
		public void addOutData(UIDataType param) {
			if (localOutData == null) {
				localOutData = new UIDataType[] {};
			}
			...
			java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
					.toList(localOutData);
			list.add(param);
			this.localOutData = (UIDataType[]) list.toArray(new UIDataType[list
					.size()]);
			...
			public static RequireSyncInteractionResponse parse(
				...
				try {
					...
					if (reader.isStartElement()
						...
						// Process the array and step past its final element's
						// end.
						list1.add(UIDataType.Factory.parse(reader));
						...
						object.setOutData((UIDataType[]) org.apache.axis2.databinding.utils.ConverterUtil
								.convertToArray(UIDataType.class, list1));
	...
	private org.apache.axiom.om.OMElement toOM(
			be.ac.fundp.webapp.client.UIClientStub.RequireAssyncInteraction param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							be.ac.fundp.webapp.client.UIClientStub.RequireAssyncInteraction.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteraction param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteraction.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (be.ac.fundp.webapp.client.UIClientStub.RequireAssyncInteraction.class
					.equals(type)) {

				return be.ac.fundp.webapp.client.UIClientStub.RequireAssyncInteraction.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteraction.class
					.equals(type)) {

				return be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteraction.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse.class
					.equals(type)) {

				return be.ac.fundp.webapp.client.UIClientStub.RequireSyncInteractionResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
