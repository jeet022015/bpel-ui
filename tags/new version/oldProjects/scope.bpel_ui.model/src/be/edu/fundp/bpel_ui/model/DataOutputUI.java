 ...
 * <ul>
 *   <li>{@link be.edu.fundp.bpel_ui.model.DataOutputUI#getOutputVariable <em>Output Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.edu.fundp.bpel_ui.model.ModelPackage#getDataOutputUI()
 * @model
 * @generated
 */
public interface DataOutputUI extends UserInteraction {
	 ...
	 * @see be.edu.fundp.bpel_ui.model.ModelPackage#getDataOutputUI_OutputVariable()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link be.edu.fundp.bpel_ui.model.DataOutputUI#getOutputVariable <em>Output Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
