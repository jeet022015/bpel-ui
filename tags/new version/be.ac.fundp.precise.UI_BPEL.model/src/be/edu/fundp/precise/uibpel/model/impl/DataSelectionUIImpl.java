 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.uibpel.model.impl.DataSelectionUIImpl#getOutputVariable <em>Output Variable</em>}</li>
...
public class DataSelectionUIImpl extends DataInputUIImpl implements DataSelectionUI {
	...
	public void setOutputVariable(Variable newOutputVariable) {
		if (newOutputVariable != outputVariable) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelPackage.DATA_SELECTION_UI__OUTPUT_VARIABLE,
	...
	public void setMinCardinality(int newMinCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 
					ModelPackage.DATA_SELECTION_UI__MIN_CARDINALITY, 
					oldMinCardinality, minCardinality));
	}
