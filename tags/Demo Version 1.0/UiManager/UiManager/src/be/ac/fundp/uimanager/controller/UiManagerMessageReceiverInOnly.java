...
/**
 * UiManagerMessageReceiverInOnly.java
 *
 ...
 */
        ...
        /**
        *  UiManagerMessageReceiverInOnly message receiver
        */

        public class UiManagerMessageReceiverInOnly extends org.apache.axis2.receivers.AbstractInMessageReceiver{
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            be.ac.fundp.uimanager.OutputOperation wrappedParam = (be.ac.fundp.uimanager.OutputOperation)fromOM(
                                                        inMessage.getEnvelope().getBody().getFirstElement(),
                                                        be.ac.fundp.uimanager.OutputOperation.class,
