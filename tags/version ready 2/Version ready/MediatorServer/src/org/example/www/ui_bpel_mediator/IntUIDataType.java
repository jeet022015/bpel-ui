 ...
 */
            ...
            /**
            *  IntUIDataType bean class
            */
        
        public  class IntUIDataType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       IntUIDataType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("Data");
                                               ...
                                               if (localData==java.lang.Integer.MIN_VALUE) {
    ...
    public static class Factory{
        ...
        */
        public static IntUIDataType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IntUIDataType object =
                new IntUIDataType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IntUIDataType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IntUIDataType)org.example.www.ui_bpel_mediator.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
