...
import be.ac.fundp.precise.ui_bpel.transformation.aui.model.core.InteractionUnitIF;
import be.ac.fundp.precise.ui_bpel.transformation.aui.model.core.SelectionUI;
import be.ac.fundp.precise.ui_bpel.transformation.aui.model.core.TriggerUI;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractCompoundIU;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractDataIU;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractDataIUType;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractInteractionUnit;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractLocalization;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractSelectionIU;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractTriggerIU;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractTriggerIUType;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.AbstractUIModel;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.DataTypeType;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.ObjectFactory;
import be.ac.fundp.precise.ui_bpel.transformation.aui.serialization.xml.SelectionType;
...
public class XML_Engine {
	 ...
	 */
	public void serialize(be.ac.fundp.precise.ui_bpel.transformation.aui.model.core.AbstractUIModel roleModel, OutputStream out3) {
