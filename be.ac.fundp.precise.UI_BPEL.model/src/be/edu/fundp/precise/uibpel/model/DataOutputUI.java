 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.uibpel.model.DataOutputUI#getOutputVariable <em>Output Variable</em>}</li>
 * </ul>
 * </p>
 *
...
public interface DataOutputUI extends UserInteraction {
	 ...
	 * @see be.edu.fundp.precise.uibpel.model.ModelPackage#getDataOutputUI_OutputVariable()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link be.edu.fundp.precise.uibpel.model.DataOutputUI#getOutputVariable <em>Output Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
