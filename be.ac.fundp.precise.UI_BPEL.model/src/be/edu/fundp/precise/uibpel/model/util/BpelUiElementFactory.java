...
public class BpelUiElementFactory{
	...
	private static BpelUiSerializer mySer = new BpelUiSerializer();
	...
	static class MyBPELWriter extends
		...
		public Element dataItem2XML(DataItem element) {
			...
			Element elem = (Element) mySer.dataItem2XML(element,staticDoc, namespace,
					getResource().getProcess(), this);
			return elem;
		}
	}
