...
import be.edu.fundp.bpel_ui.model.DataOutputUI;
import be.edu.fundp.bpel_ui.model.DataSelectionUI;
import be.edu.fundp.bpel_ui.model.DecisionUI;
import be.edu.fundp.bpel_ui.model.EventType;
...
import be.edu.fundp.bpel_ui.model.UserInteraction;
import be.edu.fundp.bpel_ui.model.UserRole;
import be.edu.fundp.bpel_ui.model.util.BPEL_UI_Constants;
import be.edu.fundp.bpel_ui.model.util.BPEL_UI_Deserializer;
import be.edu.fundp.bpel_ui.model.util.BPEL_UI_Serializer;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @generated
	 */
	private EClass newScopeEClass = null;
	 ...
	 * @see be.edu.fundp.bpel_ui.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	private static void registerSerializerAndDeserializer() {
		...
		// OnUserEvent
		String name = OnUserEvent.class.getSimpleName();
		...
		// NewScope
		name = NewScope.class.getSimpleName();
		extensionRegistry.registerActivityDeserializer(new QName(ModelPackage.eNS_URI,
				BPEL_UI_Constants.ND_NEW_SCOPE), deserializer);
		extensionRegistry.registerActivitySerializer(new QName(ModelPackage.eNS_URI, name),
				serializer);
		
		// NewEventHandler
		name = NewEventHandler.class.getSimpleName();
		extensionRegistry.registerActivityDeserializer(new QName(ModelPackage.eNS_URI,
				BPELConstants.ND_EVENT_HANDLERS), deserializer);
		extensionRegistry.registerActivitySerializer(new QName(ModelPackage.eNS_URI, name),
				serializer);
	}
	 ...
	 * @generated
	 */
	public EClass getNewScope() {
		return newScopeEClass;
	}
	...
	public void createPackageContents() {
		...
		newScopeEClass = createEClass(NEW_SCOPE);
	...
	public void initializePackageContents() {
		...
		newScopeEClass.getESuperTypes().add(theBPELPackage.getScope());
		newScopeEClass.getESuperTypes().add(theBPELPackage.getExtensionActivity());
		...
		initEClass(newScopeEClass, NewScope.class, "NewScope", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
