...
public interface ModelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__DOCUMENTATION_ELEMENT = BPELPackage.ACTIVITY__DOCUMENTATION_ELEMENT;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__ELEMENT = BPELPackage.ACTIVITY__ELEMENT;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__EEXTENSIBILITY_ELEMENTS = BPELPackage.ACTIVITY__EEXTENSIBILITY_ELEMENTS;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__DOCUMENTATION = BPELPackage.ACTIVITY__DOCUMENTATION;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__NAME = BPELPackage.ACTIVITY__NAME;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__SUPPRESS_JOIN_FAILURE = BPELPackage.ACTIVITY__SUPPRESS_JOIN_FAILURE;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__TARGETS = BPELPackage.ACTIVITY__TARGETS;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__SOURCES = BPELPackage.ACTIVITY__SOURCES;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION__ROLE = BPELPackage.ACTIVITY_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int USER_INTERACTION_FEATURE_COUNT = BPELPackage.ACTIVITY_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ON_USER_EVENT__ACTIVITY = BPEL_UI_ENTITY_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the containment reference '{@link be.edu.fundp.precise.bpel_ui.model.OnUserEvent#getActivity <em>Activity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Activity</em>'.
	 * @see be.edu.fundp.precise.bpel_ui.model.OnUserEvent#getActivity()
	 * @see #getOnUserEvent()
	 * @generated
	 */
