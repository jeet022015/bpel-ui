...
public class DataOutputUIPropertySection extends BPELPropertySection {
	...
	private DataOutputUI getActivity() {
		return (DataOutputUI)getUserInteraction();
	}
	...
	public class SetVariableCommand extends SetCommand {
		...
		@Override
		public Object get() {
			return ((DataOutputUI)fTarget).getOutputVariable();
		}
		@Override
		public void set(Object o) {
			((DataOutputUI)fTarget).setOutputVariable((Variable)o);
		}
	}
	...
	protected void createClient(Composite parent) {
		...
		Label variableLabel = fWidgetFactory.createLabel(composite, "Output Variable:"); 
	...
	public void updateVariableWidgets() {
		if (getActivity() != null ) {
			Variable variable = getActivity().getOutputVariable();
			if (variable!=null) {
