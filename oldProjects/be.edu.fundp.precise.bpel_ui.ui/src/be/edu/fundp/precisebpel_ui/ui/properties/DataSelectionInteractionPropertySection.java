...
import be.edu.fundp.precisebpel_ui.ui.details.IntegerIValue;
 ...
 */
public class DataSelectionInteractionPropertySection  extends BPELPropertySection {
	...
	protected void basicSetInput(EObject newInput) {
		...
		if (newInput instanceof DataSelectionUI) {
			fCreteInstanceController.setFeature(ModelPackage.eINSTANCE.getDataSelectionUI_MaxCardinality());
