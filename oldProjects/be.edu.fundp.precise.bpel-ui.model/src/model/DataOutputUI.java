 ...
 * <ul>
 *   <li>{@link model.DataOutputUI#getOutputVariable <em>Output Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @see model.ModelPackage#getDataOutputUI()
 * @model
 * @generated
 */
public interface DataOutputUI extends UserInteraction {
	 ...
	 * @see model.ModelPackage#getDataOutputUI_OutputVariable()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model.DataOutputUI#getOutputVariable <em>Output Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
