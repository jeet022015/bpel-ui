...
public class ModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.NEW_SCOPE: {
				NewScope newScope = (NewScope)theEObject;
				T result = caseNewScope(newScope);
				if (result == null) result = caseScope(newScope);
				if (result == null) result = caseExtensionActivity(newScope);
				if (result == null) result = caseActivity(newScope);
				if (result == null) result = caseBPEL_ExtensibleElement(newScope);
				if (result == null) result = caseExtensibleElement(newScope);
				if (result == null) result = caseWSDLElement(newScope);
				if (result == null) result = caseIElementExtensible(newScope);
				if (result == null) result = caseIAttributeExtensible(newScope);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>New Scope</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>New Scope</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNewScope(NewScope object) {
		return null;
	}
