 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.uibpel.model.impl.OnUserEventImpl#getActivity <em>Activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OnUserEventImpl extends UserInteractionImpl implements OnUserEvent {
	/**
	...
	public void setActivity(Activity newActivity) {
		if (newActivity != activity) {
			...
			if (activity != null)
				msgs = ((InternalEObject)activity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ON_USER_EVENT__ACTIVITY, null, msgs);
			if (newActivity != null)
				msgs = ((InternalEObject)newActivity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.ON_USER_EVENT__ACTIVITY, null, msgs);
