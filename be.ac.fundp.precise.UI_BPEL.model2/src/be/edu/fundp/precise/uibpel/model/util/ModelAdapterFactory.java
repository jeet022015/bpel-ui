...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch =
		new ModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDataInteraction(DataInteraction object) {
				return createDataInteractionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link be.edu.fundp.precise.uibpel.model.DataInteraction <em>Data Interaction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDataInteractionAdapter() {
		return null;
	}
