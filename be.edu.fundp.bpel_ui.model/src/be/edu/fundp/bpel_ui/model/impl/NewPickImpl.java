 ...
 * <ul>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.NewPickImpl#getCreateInstance <em>Create Instance</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.NewPickImpl#getMessages <em>Messages</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.NewPickImpl#getAlarm <em>Alarm</em>}</li>
 *   <li>{@link be.edu.fundp.bpel_ui.model.impl.NewPickImpl#getUserInteracion <em>User Interacion</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NewPickImpl extends ExtensionActivityImpl implements NewPick {
	...
	public void setCreateInstance(Boolean newCreateInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.NEW_PICK__CREATE_INSTANCE, oldCreateInstance, createInstance, !oldCreateInstanceESet));
	}
