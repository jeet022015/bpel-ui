											...
											<tr>
												<td ALIGN="left"  VALIGN="top">
													...
													<form action="/WebBrowserAppClient/InteractionManager" method="get">
														...
														%>
														<button type="submit">Send</button> <INPUT TYPE="BUTTON" VALUE="Cancel" ONCLICK="window.location.href='/WebBrowserAppClient/EventManager?processId=<%=processId%>&cuiId=<%=cuiId%>'">
													</form>
