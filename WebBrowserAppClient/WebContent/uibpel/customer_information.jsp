											...
											<tr>
												<td ALIGN="left"  VALIGN="top">
													...
													<form action='/WebBrowserAppClient/InteractionManager' method="get">
														...
														<% String name = l.get(0).getData().toString();
														String address = l.get(1).getData().toString();
														String product = l.get(2).getData().toString();%>
														<p class="MsoNormal" style="text-indent: 0cm" align="justify">
															<font size="4" face="Arial">
																<li>Customer's name: Neto</li> 
															</font>
	                									</p>
	                									<p class="MsoNormal" style="text-indent: 0cm" align="justify">
															<font size="4" face="Arial">
																<li>Customer's Address: Rue de Bruxelles</li> 
															</font>
	                									</p>
	                									<p class="MsoNormal" style="text-indent: 0cm" align="justify">
															<font size="4" face="Arial">
																<li>Product: Iphone</li> 
															</font>
	                									</p>
														
														<button type="submit">Ok</button> <INPUT TYPE="BUTTON" VALUE="Cancel" ONCLICK="window.location.href='/WebBrowserAppClient/EventManager?processId=<%=processId%>&cuiId=<%=cuiId%>'">
													</form>
