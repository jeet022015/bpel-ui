...
public class UiControler extends HttpServlet {
	...
	public UiControler() {
		...
		// cui2page.put("0", "/uibpel/interactions/input_initial_info.jsp");
		// cui2page.put("1", "/uibpel/interactions/customer_information.jsp");
		// cui2page.put("2", "/uibpel/interactions/select_shipper.jsp");
		// cui2page.put("5", "/uibpel/interactions/bill_information.jsp");
		// cui2page.put("3", "/uibpel/interactions/select_payment_method.jsp");
		// cui2page.put("4", "/uibpel/interactions/receipt.jsp");
