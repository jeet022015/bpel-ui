 ...
 * <ul>
 *   <li>{@link be.edu.fundp.precise.bpel_ui.model.EventHandlerUI#getUserInteraction <em>User Interaction</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.edu.fundp.precise.bpel_ui.model.ModelPackage#getEventHandlerUI()
 * @model
 * @generated
 */
public interface EventHandlerUI extends EventHandler, BPEL_UI_Entity {
	/**
	 ...
	 * @see be.edu.fundp.precise.bpel_ui.model.ModelPackage#getEventHandlerUI_UserInteraction()
