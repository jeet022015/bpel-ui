 ...
 */
            ...
            /**
            *  BooleanUIDataType bean class
            */
        
        public  class BooleanUIDataType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = BooleanUIDataType
                           ...
                           */
                           public  boolean getData(){
                            ...
                            /**
                               ...
                               * @param param Data
                               */
                               public void setData(boolean param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       BooleanUIDataType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BooleanUIDataType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BooleanUIDataType",
    ...
    public static class Factory{
        ...
        */
        public static BooleanUIDataType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BooleanUIDataType object =
                new BooleanUIDataType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BooleanUIDataType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BooleanUIDataType)org.example.www.ui_bpel_mediator.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
